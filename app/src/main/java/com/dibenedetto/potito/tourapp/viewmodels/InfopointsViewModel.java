...
public class InfopointsViewModel extends AndroidViewModel {
    ...
    public InfopointsViewModel(Application application) {
        super(application);
        mRepository = new TourAppRepository(application);
        mInterests = mRepository.getCategrieSecondarieOf(Const.INFOPOINTS_ID);
